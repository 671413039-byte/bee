...
class HarvestRecordsFormPage extends StatefulWidget {
  final int? recordId;
  ...
  @override
  State<HarvestRecordsFormPage> createState() => _HarvestRecordsFormPageState();
}

class _HarvestRecordsFormPageState extends State<HarvestRecordsFormPage> {
  ...
  Future<void> _submitRecord() async {
    ...
    try {
      debugPrint("Submitting record - xcase: ${widget.xcase}, ID: ${widget.recordId}, OriginalDate: ${widget.harvestDate}, NewDate: $dateText, BeehiveCount: $beehiveCountText, YieldBottles: $yieldBottlesText, MemberId: $selectedMemberId");
      ...
      final response = await http.post(
        ...
        body: {
          ...
          "harvestDate": widget.xcase == 2 ? (widget.harvestDate ?? dateText) : dateText,
          "newHarvestDate": widget.xcase == 2 ? dateText : "",
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.xcase == 1) {
      titleText = "เพิ่มบันทึกการเก็บเกี่ยว";
    } else if (widget.xcase == 2) {
      titleText = "แก้ไขบันทึกการเก็บเกี่ยว";
    } else {
      titleText = "บันทึกการเก็บเกี่ยว";
    }
